...
const checks = [
  ...
  ['deploy tag atual', /deploy-v20260715i/],
  ['cadastros recorrentes inclui órfãos', /function getRecurringCadastros\(/],
  ['exclusão recorrente por nome duplicado', /function collectRecurringDeleteIds\(/],
